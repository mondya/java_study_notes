...
![image-20220721215923086](https://gitee.com/cnuto/images/raw/master/image/image-20220721215923086.png)
...
![](https://gitee.com/cnuto/images/raw/master/image/RocketMQ-0726.png)
...
![image-20220815211347214](https://gitee.com/cnuto/images/raw/master/image/image-20220815211347214.png)
...
![image-20220815212826370](https://gitee.com/cnuto/images/raw/master/image/image-20220815212826370.png)
...
![image-20221110215727779](https://gitee.com/cnuto/images/raw/master/image/indexHeader结构图.png)
...
![image-20230130221350608](https://gitee.com/cnuto/images/raw/master/image/image-20230130221350608.png)
...
![image-20230131203906571](https://gitee.com/cnuto/images/raw/master/image/image-20230131203906571.png)

该算法是要根据avg = QueueCount / ConsumerCount的计算结果进行分配的。如果能够整除，则按顺序将avg个Queue逐个分配给Consumer；如果不能整除，则将多余的Queue按照Consumer顺序逐个分配

#### 环形平均策略

![image-20230131204324318](https://gitee.com/cnuto/images/raw/master/image/image-20230131204324318.png)
...
![image-20230131204659656](https://gitee.com/cnuto/images/raw/master/image/image-20230131204659656.png)

该算法会将consumer的hash值作为Node节点存放到hash环上，然后将queue的hash值也放到hash环上，通过顺时针方向，距离queue最近的consumer就是该queue要分配的consumer。

#### 同机房策略

![image-20230131205231452](https://gitee.com/cnuto/images/raw/master/image/image-20230131205231452.png)
...
![image-20230131211129366](https://gitee.com/cnuto/images/raw/master/image/image-20230131211129366.png)

![image-20230131211213438](https://gitee.com/cnuto/images/raw/master/image/image-20230131211213438.png)
...
![image-20230201224041868](https://gitee.com/cnuto/images/raw/master/image/image-20230201224041868.png)
...
![image-20230201224330091](https://gitee.com/cnuto/images/raw/master/image/image-20230201224330091.png)
...
![image-20230201224635972](https://gitee.com/cnuto/images/raw/master/image/image-20230201224635972.png)
...
![image-20230202222354414](https://gitee.com/cnuto/images/raw/master/image/image-20230202222354414.png)

这种情况下，我们希望consumer消费消息的顺序和producer发送是一致的，然而上述mq的投递和消费方式，我们无法保证顺序是正确的。对于顺序异常的消息，consumer即使设置一定的状态容错，也不能完全处理好多种随机出现的组合情况。

![image-20230202222916292](https://gitee.com/cnuto/images/raw/master/image/image-20230202222916292.png)
...
![image-20230203214202308](https://gitee.com/cnuto/images/raw/master/image/image-20230203214202308.png)
...
![image-20230205154033784](https://gitee.com/cnuto/images/raw/master/image/image-20230205154033784.png)
...
![image-20230205155215891](https://gitee.com/cnuto/images/raw/master/image/image-20230205155215891.png)
...
![image-20230207231920148](https://gitee.com/cnuto/images/raw/master/image/image-20230207231920148.png)
